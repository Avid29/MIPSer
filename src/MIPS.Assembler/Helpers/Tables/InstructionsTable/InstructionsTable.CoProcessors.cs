...
public static partial class InstructionsTable
{
    ...
    private static readonly Dictionary<string, InstructionMetadata> _coProcInstructionTable = new()
    {
        ...
        { "lwc3",   new("lwc3",     OperationCode.LoadWordCoprocessor3,     LoadCoprocessor,    Version.MipsIaII) },
        ...
        { "swc3",   new("swc3",     OperationCode.StoreWordCoprocessor3,    StoreCoprocessor,   Version.MipsIaII) },
